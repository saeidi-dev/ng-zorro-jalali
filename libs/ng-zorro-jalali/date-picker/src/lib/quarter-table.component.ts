...
import { DateHelperService } from 'ng-zorro-jalali/i18n';
import { CandyDate } from 'ng-zorro-jalali/core';
...
export class QuarterTableComponent extends AbstractTable implements OnChanges, OnInit {
  ...
  private isDisabledQuarter(quarter: CandyDate): boolean {
    ...
    const firstDayOfQuarter = this.candyDate(startOfQuarter(quarter.nativeDate));

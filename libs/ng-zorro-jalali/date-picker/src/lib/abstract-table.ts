...
import { CandyDate, CandyDateFac, CANDY_DATE } from 'ng-zorro-jalali/core';
import { FunctionProp } from 'ng-zorro-antd/core/types';
import { NzCalendarI18nInterface } from 'ng-zorro-antd/i18n';

import { DateBodyRow, DateCell } from './interface';
import { NZ_DATE_FORMATS, NzDateDisplayFormats } from 'ng-zorro-jalali/i18n';
...
export abstract class AbstractTable implements OnInit, OnChanges {
  ...
  protected candyDate: CandyDateFac = inject<CandyDateFac>(CANDY_DATE);
  protected dateFormats: NzDateDisplayFormats = inject(NZ_DATE_FORMATS);
